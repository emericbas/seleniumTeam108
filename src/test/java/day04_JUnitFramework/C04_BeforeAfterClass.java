...
public class C04_BeforeAfterClass {
    ...
    // 1.de amazon anasayfaya gidip, gittiginizi test edin.
    // 2. de Nutella aratip arama sonuclarinin Nutella icerdigini test edin
    // 3. de Ilk urune tiklayip ,urun isminde Nutella gectigini test edin

    //Eger her bir test methodu icin driver olusturup, sonunda kapatmamiz gerekmiyorsa
