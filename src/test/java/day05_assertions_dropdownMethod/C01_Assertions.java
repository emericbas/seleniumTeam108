package day05_assertions_dropdownMethod;
...
public class C01_Assertions {
 ...
 2) https://www.youtube.com adresine gidin
    ...
    public static void setup(){
        ...
        WebElement cookiesKabulButonu= driver.findElement(By.
                xpath
                        ("(//div[@class='yt-spec-touch-feedback-shape yt-spec-touch-feedback-shape--touch-response-inverse'])[2]"));
